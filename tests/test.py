...
# 		self.assertEqual(len(allocated_fellow_list), 1)
	...
	def test_that_staff_assigned_to_office_space_do_not_exceed_six(self):
		...
		self.amity.create_person({"person_name":"oscar opondo",
			"role":"staff",
			"wants_accomodation":"no"})
		self.amity.create_person({"person_name":"jane opondo",
			"role":"staff",
			"wants_accomodation":"no"})
		self.amity.create_person({"person_name":"roll opondo",
			"role":"staff",
			"wants_accomodation":"no"})
		self.amity.create_person({"person_name":"alex opondo",
			"role":"staff",
			"wants_accomodation":"no"})
		self.amity.create_person({"person_name":"annie opondo",
			"role":"staff",
			"wants_accomodation":"no"})
		self.assertEqual(len(oculus.occupants), 5)
